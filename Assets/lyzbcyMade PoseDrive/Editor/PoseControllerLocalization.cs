            ...
            {
                {
                    PoseDriveLanguage.ChineseSimplified, new Dictionary<string, string>
                    {
                        ...
                        ["wizard.step1"] = "1. 检查依赖",
                        ["wizard.step1.desc"] = "确保 Sentis 与摄像头可用。",
                        ["wizard.step2"] = "2. 选择模型",
                        ...
                        ["wizard.model.noBarracuda"] = "Sentis 包未安装。请先在步骤 1 中安装 Sentis 包。",
                        ["wizard.step3"] = "3. 输入映射",
                        ...
                        ["wizard.dependency.barracuda.name"] = "Sentis",
                        ["wizard.dependency.barracuda.tip"] = "神经网络推理依赖 Sentis 包，缺失时将无法运行 MoveNet 与动作分类。",
                        ...
                        ["wizard.dependency.barracuda.install"] = "自动安装 Sentis",
                        ["wizard.dependency.barracuda.install.confirm"] = "是否要将 Sentis 包添加到项目的 manifest.json 中？\n\n这将通过 GitHub 仓库链接自动安装 Sentis。",
                        ["wizard.dependency.barracuda.install.success"] = "Sentis 已添加到项目依赖中。\n\nUnity 将自动下载并导入该包，请稍候片刻。",
                        ["wizard.dependency.barracuda.install.error"] = "安装失败：{0}",
                        ["wizard.dependency.barracuda.install.already"] = "Sentis 已存在于项目依赖中。",
                ...
                },
                {
                    PoseDriveLanguage.English, new Dictionary<string, string>
                    {
                        ...
                        ["wizard.step1.desc"] = "Ensure Sentis and camera access are available.",
                        ...
                        ["wizard.model.noBarracuda"] = "Sentis package is not installed. Please install Sentis in Step 1 first.",
                        ...
                        ["wizard.dependency.barracuda.name"] = "Sentis",
                        ["wizard.dependency.barracuda.tip"] = "Sentis package is required for MoveNet and action classifier.",
                        ...
                        ["wizard.dependency.barracuda.install"] = "Install Sentis",
                        ["wizard.dependency.barracuda.install.confirm"] = "Add Sentis package to your project's manifest.json?\n\nThis will automatically install Sentis via GitHub repository link.",
                        ["wizard.dependency.barracuda.install.success"] = "Sentis has been added to project dependencies.\n\nUnity will automatically download and import the package. Please wait a moment.",
                        ["wizard.dependency.barracuda.install.error"] = "Installation failed: {0}",
                        ["wizard.dependency.barracuda.install.already"] = "Sentis already exists in project dependencies.",
                ...
                },
                {
                    PoseDriveLanguage.Japanese, new Dictionary<string, string>
                    {
                        ...
                        ["wizard.step1.desc"] = "Sentis とカメラが利用可能か確認します。",
                        ...
                        ["wizard.model.noBarracuda"] = "Sentis パッケージがインストールされていません。まずステップ 1 で Sentis をインストールしてください。",
                        ...
                        ["wizard.dependency.barracuda.name"] = "Sentis",
                        ["wizard.dependency.barracuda.tip"] = "MoveNet とアクション分類には Sentis パッケージが必要です。",
                        ...
                        ["wizard.dependency.barracuda.install"] = "Sentis を自動インストール",
                        ["wizard.dependency.barracuda.install.confirm"] = "Sentis パッケージをプロジェクトの manifest.json に追加しますか？\n\nGitHub リポジトリリンク経由で Sentis を自動インストールします。",
                        ["wizard.dependency.barracuda.install.success"] = "Sentis がプロジェクトの依存関係に追加されました。\n\nUnity が自動的にパッケージをダウンロードしてインポートします。しばらくお待ちください。",
                        ["wizard.dependency.barracuda.install.error"] = "インストールに失敗しました：{0}",
                        ["wizard.dependency.barracuda.install.already"] = "Sentis は既にプロジェクトの依存関係に存在します。",
