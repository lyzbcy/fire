            ...
            {
                {
                    GitLanguage.ChineseSimplified, new Dictionary<string, string>
                    {
                        ...
                        ["notify.branchCreated"] = "已创建并切换到分支：{0}",
                        ["log.title"] = "最近提交 (git log --graph)",
                        ["log.empty"] = "暂无日志，可先进行一次提交。",
                        ["log.pullDialogTitle"] = "拉取指定版本",
                        ["log.pullDialogMessage"] = "确定要从 {2}/{3} 拉取提交 {0}？\n\n{1}",
                ...
                },
                {
                    GitLanguage.English, new Dictionary<string, string>
                    {
                        ...
                        ["notify.branchCreated"] = "Created and switched to branch: {0}",
                        ["log.title"] = "Recent commits (git log --graph)",
                        ["log.empty"] = "Log is empty. Make a commit to get started.",
                        ["log.pullDialogTitle"] = "Pull selected revision",
                        ["log.pullDialogMessage"] = "Pull commit {0} from {2}/{3}?\n\n{1}",
                        ["log.pullDialogConfirm"] = "Pull",
                ...
                },
                {
                    GitLanguage.Japanese, new Dictionary<string, string>
                    {
                        ...
                        ["notify.branchCreated"] = "ブランチを作成し切り替えました：{0}",
                        ["log.title"] = "直近のコミット (git log --graph)",
                        ["log.empty"] = "履歴はまだありません。まずはコミットしましょう。",
                        ["log.pullDialogTitle"] = "指定した履歴を取得",
                        ["log.pullDialogMessage"] = "{2}/{3} からコミット {0} を取得しますか？\n\n{1}",
                        ["log.pullDialogConfirm"] = "取得",
